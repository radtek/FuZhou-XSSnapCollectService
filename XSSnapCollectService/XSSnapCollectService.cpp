// XSSnapCollectService.cpp : 定义控制台应用程序的入口点。
//
...
int main()
{
    CSnapCollectService snapCollect;
    if (!snapCollect.StartService())
    {
        printf("SnapCollectService Start Failed!\nPress Any Key Return...\n");
        getchar();
    }
    return 0;
}
...
#include "ntservice.h"
#include <iostream>
#define SERVICE_NAME "XSSnapCollectService"
//本地函数定义
